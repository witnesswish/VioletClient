...
RegisterViolet::RegisterViolet(QTcpSocket *socket, QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::RegisterViolet)
{
    ...
    ui->setupUi(this);
    sock = socket;
    connect(sock, &QTcpSocket::readyRead, this, &RegisterViolet::read_cb);
...
void RegisterViolet::closeEvent(QCloseEvent *ev)
{
    ...
    disconnect(sock, &QTcpSocket::readyRead, this, &RegisterViolet::read_cb);
    emit sclose();
    ev->accept();
}
