...
LoginCenter::LoginCenter(QTcpSocket *socket, QWidget *parent)
    : QWidget(parent)
...
void LoginCenter::on_vregister_pressed() {
    disconnect(sock, &QTcpSocket::readyRead, this, &LoginCenter::read_cb);
    reg = new RegisterViolet(sock);
    connect(reg, &RegisterViolet::sclose, this, [this](){this->show();connect(sock, &QTcpSocket::readyRead, this, &LoginCenter::read_cb);});
    this->hide();
    reg->show();
}
