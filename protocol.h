...
public:
    SRHelper();
    void sendMsg(QTcpSocket *sock, uint16_t msgType, const std::string &content);
    void sendMsg(QTcpSocket *sock, VioletProtHeader header, const std::string &content);
    void sendMsg(QTcpSocket *sock, VioletProtNeck neck, const std::string &content);
    void sendMsg(QTcpSocket *sock, VioletProtHeader header, VioletProtNeck neck, const std::string &content);
    std::optional<Msg> recvMsg(QTcpSocket *sock, ssize_t byteToRead);
};
