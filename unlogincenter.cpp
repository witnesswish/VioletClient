...
UnloginCenter::UnloginCenter(QTcpSocket *socket, int uid, QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::UnloginCenter)
{
    ...
    displayAppend(
        ...
        Qt::AlignCenter);
    connect(sock, &QTcpSocket::readyRead, this, &UnloginCenter::read_cb);
...
void UnloginCenter::closeEvent(QCloseEvent *event)
{
    ...
    if (1) { // 自定义条件检查
        disconnect(sock, &QTcpSocket::readyRead, this, &UnloginCenter::read_cb);
